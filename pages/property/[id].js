...
import PhotoScrollbar from "../../components/PhotoScrollbar";

const PropertyDetails = ({ propertyDetails: { price, title, rooms, rentFrequency, baths, area, agency, isVerified, description, type, purpose, furnishingStatus, amenities, photos } }) => (
    <Box maxWidth='1000px' margin='auto' p='4'>
        {
            photos && <PhotoScrollbar data={photos} />
        }
        <Box w='full' p='6'>
            {/* this baby comming from Property component, */}
